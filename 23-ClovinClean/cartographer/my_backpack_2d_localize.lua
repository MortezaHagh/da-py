...
MAP_BUILDER.num_background_threads = 10 -- Increase up to number of cores

TRAJECTORY_BUILDER.pure_localization_trimmer = { max_submaps_to_keep = 15.000000,}

TRAJECTORY_BUILDER.initial_trajectory_pose = {relative_pose = {translation = {x = 0.0, y = 0.0, z = 0.,},rotation = {r_x = 0., r_y = 0., r_z = 0.0, r_w = 1.0,},},to_trajectory_id = 0,timestamp = 0,}

TRAJECTORY_BUILDER_2D.min_range = 0.4
TRAJECTORY_BUILDER_2D.max_range = 16.000000
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 5 --changed was 5.5
...
POSE_GRAPH.global_constraint_search_after_n_seconds = 3600

POSE_GRAPH.constraint_builder.sampling_ratio = 0.015
POSE_GRAPH.constraint_builder.min_score = 0.52
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.53
POSE_GRAPH.constraint_builder.max_constraint_distance = 12.

--POSE_GRAPH.optimization_problem.odometry_rotation_weight = 4
...
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 2.5e6
POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 1e6
POSE_GRAPH.optimization_problem.local_slam_pose_translation_weight = 1e3 -- 1e5
POSE_GRAPH.optimization_problem.local_slam_pose_rotation_weight = 1e3-- 1e5
